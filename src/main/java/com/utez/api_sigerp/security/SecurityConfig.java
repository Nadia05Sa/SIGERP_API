    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.PATCH, "/api/mesas/**", "/api/ordenes/{id}","/api/producto/{id}", "/api/categoria/{id}/estado","/api/producto/{id}","/api/mesas/{id}/vincularOrden/{idO}", "/api/ordenes/{id}/estado").permitAll()
